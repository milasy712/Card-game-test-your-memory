...
const items = [
    ...
    { name: "frenchfries", image: "frenchfries.jpg" },
    { name: "grape", image: "grape.jpg" },
    { name: "iceccone", image: "iceccone.jpg" },
    { name: "pizza", image: "pizza.jpg" },
    { name: "sate", image: "sate.jpg" },
...
const matrixGenerator = (cardValues, size = 4) => {
    ...
    //simple shuffle
    cardValues.sort(() => Math.random() - 0.9);
                ...
                if (!firstCard) {
                    ...
                    if (firstCardValue == secondCardValue) {
                        ...
                        if (winCount == Math.floor(cardValues.length / 2)) {
                            result.innerHTML = `<h2>Congratulation, You Win!</h2>
